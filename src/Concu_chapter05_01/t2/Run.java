...
public class Run {
    ...
    public static void main(String[] args){
        try {
            ...
            String dateString1 = "2017-01-12 10:13:00";
            String dateString2 = "2017-01-12 10:13:20";
            Date dateRef1 = sdf1.parse(dateString1);
            Date dateRef2 = sdf2.parse(dateString2);
            System.out.println("字符串1时间：" + dateRef1.toLocaleString() + " 当前时间:" + new Date().toLocaleString());
            System.out.println("字符串2时间：" + dateRef1.toLocaleString() + " 当前时间:" + new Date().toLocaleString());
